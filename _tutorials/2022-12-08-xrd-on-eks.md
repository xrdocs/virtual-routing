...
![ECR]({{base_path}}/images/ecr-upload.png)
...
![s3-view]({{base_path}}/images/s3-view.png)
![s3-assets]({{base_path}}/images/s3-assets.png)
...
![create-stack]({{base_path}}/images/create-stack.png)
...
![s3-url]({{base_path}}/images/s3-url.png)
#### Create Stack
![]({{base_path}}/images/create-stack-step1.png)
...
![]({{base_path}}/images/create-stack-step2.png)
#### Launch Stack
...
![]({{base_path}}/images/create-stack-step4.png)
...
![]({{base_path}}/images/stack-events.png)

## Connect to XRd
Navigate to the instances view in the AWS Console.
![]({{base_path}}/images/xrd-instances.png)
...
First, we'll set a static route to the gateway.

```
RP/0/RP0/CPU0:xrd(config)#router static
RP/0/RP0/CPU0:xrd(config-static)#address-family ipv4 unicast 
RP/0/RP0/CPU0:xrd(config-static-afi)#0.0.0.0/0 10.0.1.1
RP/0/RP0/CPU0:xrd(config-static-afi)#commit
```

Next, enable ssh

```
RP/0/RP0/CPU0:xrd#conf
RP/0/RP0/CPU0:xrd(config)#ssh server v2
RP/0/RP0/CPU0:xrd(config)#commit
```
